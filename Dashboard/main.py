...
st.markdown('This dashboard is designed to explore the dataset used for my Li Keqiang Index project. For more on the project, [click here](https://wijama.org/2023/12/15/Li-Keqiang-Index-Introduction-and-EDA.html).')
...
if st.checkbox('Insert Trendline'):
    scatter_trendline="ols"
else:
    scatter_trendline=None
if st.checkbox('Color points by Region'):
    color_region = "Region"
else:
    color_region = None
...
st.markdown('Examine the number of data points from each region. [See a discussion on this in EDA.](https://wijama.org/2023/12/15/Li-Keqiang-Index-Introduction-and-EDA.html#:~:text=A%20countplot%20of%20data)')
